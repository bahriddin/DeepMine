import gym
from policy_gradient_epsilon import PolicyGradient
...
if __name__ == "__main__":
    ...
    learning_rate=0.001
    load_path=None
    save_path = str(learning_rate)+'_loss_steps'
    reward_path = save_path + '/rlist'
    step_path=save_path+'/steplist'
    loss_path=save_path+'/losslist'
        ...
        while True:
            ...
            if done:
                ...
                if episode > 0 and episode % 200 == 0:
                    ...
                    np.save(step_path,np.array(steps))
                    np.save(loss_path,np.array(PG.losshis))
