...
tuning = [
    {
        ...
        'uf': 10,
        'hlu': 50,
        'output_dir': './ddqn-per-final',
        'output_name': 'LunarLander-DDQN-PER'
    },
    {
        'lr': 0.0001,
        'memory': 500000,
...
class Agent:
    ...
    def _getTargets(self, batch):
        ...
        policies_ = agent.brain.predict(states_, target=False)
        ...
        for i in range(len(batch)):
            ...
            if s_ is None:
                ...
                t[a] = r + GAMMA * pTarget_[i][numpy.argmax(policies_[i])]  # double DQN
